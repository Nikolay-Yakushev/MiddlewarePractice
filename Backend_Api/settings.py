...
MIDDLEWARE = [
    ...
    "backend_users.middleware.IpCheckMiddleware",
    "backend_users.middleware.WhiteListMiddleware",
    "django.middleware.common.CommonMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",
    "backend_users.middleware.RedisAuthMiddleware",
...
STATIC_URL = "/static/"
# todo docker run --name redis -d -p 6379:6379 redis redis-server --requirepass "SUPER_SECRET_PASSWORD"
